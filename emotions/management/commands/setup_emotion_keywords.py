...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        keywords_data = {
            ...
            '힘들어요': [
                # 핵심 키워드 (높은 가중치)
                ('지침', 3.0, '몸과 마음이 모두 피로한 상태'),
                ('휴식', 3.0, '쉬면서 에너지를 회복하는 시간'),
                ('위로', 2.5, '마음을 달래주는 따뜻한 말과 행동'),
                ('쉼', 2.5, '잠시 멈추고 재충전하는 것'),
                ('회복', 2.0, '지친 상태에서 다시 힘을 얻는 것'),
                ('안정', 2.0, '불안과 긴장을 내려놓는 상태'),
                
                # 보조 키워드 (중간 가중치)
                ('자기돌봄', 1.5, '스스로를 돌보고 챙기는 태도'),
                ('휴양', 1.5, '몸과 마음을 쉬게 하는 시간'),
                ('재충전', 1.5, '힘을 다시 채우는 과정'),
                ('느림', 1.5, '급하지 않게 천천히 가는 것'),
                ('위안', 1.0, '마음이 조금 가벼워지는 느낌'),
                ('안식', 1.0, '평화롭게 쉴 수 있는 상태'),
                ('온기', 1.0, '따뜻한 감정과 분위기'),
                ('회복탄력', 1.0, '다시 일어설 수 있는 힘'),
            ],
