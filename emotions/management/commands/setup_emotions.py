    ...
    def handle(self, *args, **options):
        ...
        emotions_data = [
            ...
            },
            {
                ...
                'emoji': '😫',
                'color_code': '#a78bfa',
                'description': '지치고 피곤해서 쉬고 싶어요',
                'sub_description': '쉬고싶어요',
                'order': 8
            }
        ]
        ...
        recommendations_data = [
            ...
            # 힘들어요
            ('힘들어요', '치유물', 1, '지친 마음을 천천히 회복하고 위로받는 과정을 통해 다시 힘을 얻을 수 있어요.', 94),
            ('힘들어요', '일상물', 2, '소소한 일상의 이야기로 마음을 안정시키고 휴식을 취할 수 있어요.', 89),
            ('힘들어요', '가족물', 3, '가족의 사랑과 따뜻한 유대감을 통해 마음이 회복될 수 있어요.', 85),
