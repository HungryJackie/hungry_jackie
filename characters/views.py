...
def generate_character_guide(emotion, genre):
    ...
    guide_templates = {
        ...
        ('힘들어요', '치유물'): {
            'personality_suggestions': [
                '따뜻하고 인내심이 강한 성격',
                '타인의 고통에 깊이 공감할 수 있는 캐릭터',
                '지친 사람들을 편안하게 해주는 존재',
                '상처를 이해하고 함께 회복하려는 성격'
            ],
            'speaking_style_suggestions': [
                '부드럽고 다정한 말투, "괜찮아요", "오늘은 쉬어가요"',
                '조용하지만 진심 어린 위로를 전하는 말투',
                '상대방의 감정을 존중하며 말하는 톤',
                '불안한 마음을 진정시켜주는 느린 템포의 말투'
            ],
            'background_suggestions': [
                '요양원, 북카페, 바닷가 마을 등 평온한 장소에서 지내는 인물',
                '한때 번아웃을 겪고 회복의 과정을 경험한 사람',
                '다른 사람의 회복을 돕는 직업 (상담사, 아로마테라피스트 등)',
                '소소한 일상 속에서 행복을 찾아가는 캐릭터'
            ]
        },

        ('힘들어요', '일상물'): {
            'personality_suggestions': [
                '잔잔하고 현실적인 감정을 표현하는 성격',
                '소소한 행복을 찾아가는 긍정적인 인물',
                '무기력하지만 점점 변화를 시도하는 캐릭터',
                '조용하지만 따뜻한 내면을 가진 성격'
            ],
            'speaking_style_suggestions': [
                '짧고 솔직한 문장을 사용하는 현실적인 말투',
                '"요즘 좀 힘들어요", "그래도 괜찮아지겠죠" 같은 공감형 대사',
                '감정 표현은 적지만 진심이 느껴지는 말투',
                '조용히 위로를 건네는 차분한 톤'
            ],
            'background_suggestions': [
                '회사나 학교에서 지친 일상을 보내는 인물',
                '하루하루를 버텨내는 현실적인 배경',
                '소박한 집이나 작은 카페 같은 일상 공간에서 생활',
                '일상 속 작은 변화를 통해 회복하는 이야기'
            ]
        },

        ('힘들어요', '가족물'): {
            'personality_suggestions': [
                '책임감 있고 가족을 위해 헌신하는 성격',
                '불안 속에서도 가족에게 위로를 주는 인물',
                '상처받았지만 여전히 따뜻한 마음을 가진 캐릭터',
                '가족의 사랑으로 회복하는 인물상'
            ],
            'speaking_style_suggestions': [
                '진심이 느껴지는 현실적인 말투',
                '"괜찮아, 내가 있을게" 같은 따뜻한 위로 표현',
                '때로는 감정이 격해지지만 결국 사랑이 중심인 대사',
                '부드러운 존댓말과 가족 특유의 친근한 말투 혼합'
            ],
            'background_suggestions': [
                '가족을 돌보며 지내는 일상형 인물',
                '어려운 환경에서도 가족을 지키려는 이야기',
                '가족 간의 오해와 화해가 중심인 서사',
                '가족의 존재가 인물의 회복의 핵심으로 작용'
            ]
        },
